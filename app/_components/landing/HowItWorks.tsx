        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-10 md:gap-8 items-center md:items-start">
          ...
          {steps.map((step, index) => (
            <div key={step.id} className="flex flex-col items-center text-center w-full">
              ...
              {/* Title */}
              <h3 className="text-[16px] font-bold text-black uppercase tracking-wider leading-snug mb-3">
              ...
              {/* Description */}
              <p className="text-[16px] md:text-[18px] text-black leading-relaxed max-w-[280px]">
                {step.description}
              </p>
