    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-[60%_40%] text-white py-14 items-center">
        ...
        <div className="pr-12">
          ...
          <p className="mt-4 text-[14px] text-white/90 max-w-lg leading-relaxed">
        ...
        <div className="pl-12 flex flex-col gap-6 items-center justify-center">
          ...
          <div className="flex items-center gap-4 w-fit">
            ...
            <a href="mailto:info@shaper.co.za" className="text-[15px] font-semibold hover:underline">
              info@shaper.co.za
            </a>
          </div>
          ...
          <div className="flex items-center gap-4 w-fit">
            ...
            <a href="tel:0115686887" className="text-[15px] font-semibold hover:underline">
              011 568 6887
            </a>
          </div>
